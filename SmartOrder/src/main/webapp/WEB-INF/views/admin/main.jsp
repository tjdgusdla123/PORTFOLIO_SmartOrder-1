        ...
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="page-heading">
            ...
            <span class="subheading">
            	...
            	관리자 페이지 입니다.<br/><br/>
            	 관리자 ${storememberinfo.storemembernickname}님 반갑습니다.
            	</c:if></span>
          </div>
        </div>
      </div>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					...
					<c:if test="${storememberinfo.result == null}">
						...
						<!-- 관리자 -->
						<c:if test="${storememberinfo.storememberverify == '9'}">
						<li class="nav-item"><a class="nav-link" href="/admin/menu">메뉴관리</a></li>
						<li class="nav-item"><a class="nav-link" href="/admin/board">게시판관리</a></li>
						<li class="nav-item"><a class="nav-link" href="/admin/info">관리자정보관리</a></li>
